...
//empty state (or main page)

//drag in must enable or disable a checkbox, depending on the new state of the last mousedown checkbox

//add options menu/modal (hotkeys, theme, )

//add delay on some hovers (like new to-do)

//due icon as favicon

//marquee effect on long text
...
const ui = (() => {
  ...
  function placeSingleCard(todo, projectIdx, todoIdx){
    ...
    dateDue.innerText = todo.dateDue.length > 0 ? `Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todo.dateDue)), dateFormat)}` : "";
  ...
  function editField(){
    ...
    if(this.className.includes("edit-title")){
      ...
      thisDateDue.innerText = this.value.length > 0 ? `Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(this.value)), dateFormat)}` : "";
