...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/menu.svg */ "./src/media/images/icons/menu.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/background/github-mark.svg */ "./src/media/images/background/github-mark.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/due.svg */ "./src/media/images/icons/due.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/remove-task.svg */ "./src/media/images/icons/remove-task.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/pin.svg */ "./src/media/images/icons/pin.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_5___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/pin-active.svg */ "./src/media/images/icons/pin-active.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_6___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/edit.svg */ "./src/media/images/icons/edit.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/edit-active.svg */ "./src/media/images/icons/edit-active.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_8___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/fav.svg */ "./src/media/images/icons/fav.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_9___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/fav-active.svg */ "./src/media/images/icons/fav-active.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_10___ = new URL(/* asset import */ __webpack_require__(/*! ./media/images/icons/add-task.svg */ "./src/media/images/icons/add-task.svg"), __webpack_require__.b);
...
//run on load
_modules_ui_js__WEBPACK_IMPORTED_MODULE_1__.ui.loadMenu();
_modules_ui_js__WEBPACK_IMPORTED_MODULE_1__.ui.placeCards(0);

//TODO:

//search with datalist if possible

//empty state (or main page, notes included)

//add options menu/modal (hotkeys, theme, )
...
/* harmony export */ });
/* harmony import */ var _todoSample_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todoSample.js */ "./src/modules/todoSample.js");
/* harmony import */ var _classes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classes.js */ "./src/modules/classes.js");
...
const todoHandler = (() => {
  ...
  function getProject(request){
    ...
    if(typeof request === "number"){
      ...
      local.forEach((thisProject, projectIdx) => thisProject.todos.forEach((thisTodo, todoIdx) => {
        ...
        if((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(formatDate))){
          thisTodo.projectIdx = projectIdx;
          thisTodo.todoIdx = todoIdx;
          filtered.todos.push(thisTodo);
        };
      ...
      local.forEach((thisProject, projectIdx) => thisProject.todos.forEach((thisTodo, todoIdx) => {
        const formatDate = thisTodo.dateDue.split("-").join(",");
        if((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(formatDate))
        &&(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(formatDate))){
          thisTodo.projectIdx = projectIdx;
          thisTodo.todoIdx = todoIdx;
          filtered.todos.push(thisTodo);
        };
      ...
      local.forEach((thisProject, projectIdx) => thisProject.todos.forEach((thisTodo, todoIdx) => {
        const formatDate = thisTodo.dateDue.split("-").join(",");
        if((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(formatDate))
        &&(0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(formatDate))){
          thisTodo.projectIdx = projectIdx;
          thisTodo.todoIdx = todoIdx;
          filtered.todos.push(thisTodo);
        };
      ...
      local.forEach((thisProject, projectIdx) => thisProject.todos.forEach((thisTodo, todoIdx) => {
        const formatDate = thisTodo.dateDue.split("-").join(",");
        if((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(formatDate))
        &&(0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(formatDate))){
          thisTodo.projectIdx = projectIdx;
          thisTodo.todoIdx = todoIdx;
          filtered.todos.push(thisTodo);
        };
      ...
      local.forEach((thisProject, projectIdx) => thisProject.todos.forEach((thisTodo, todoIdx) => {
        const formatDate = thisTodo.dateDue.split("-").join(",");
        if(!(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(formatDate))
        && !(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(formatDate))
  ...
  function createTodo(projectIdx){
    ...
    const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), "yyyy-MM-dd");
    
    local[projectIdx].todos.push(
      new _classes_js__WEBPACK_IMPORTED_MODULE_1__.Todo(todoName, "", date, "", [], "low", false, false)
      );
    setLocalStorage(local);
  }
  ...
  function loadSample(){
    if(localStorage.length === 0){
      localStorage.setItem("todo", JSON.stringify(_todoSample_js__WEBPACK_IMPORTED_MODULE_0__.todoSample));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "todoSample": () => (/* binding */ todoSample)
/* harmony export */ });
...
const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), "yyyy-MM-dd");
    
const todoSample = [
  {
    title: "How to use",
    todos: [
      new _classes_js__WEBPACK_IMPORTED_MODULE_0__.Todo("1) Creating a project", "These are the steps to create a new project", date,"", [
        ...
        { task: "• If you want to delete a project, hold on the bin", isDone: false },
        { task: "next to it's title on the menu", isDone: false },
      ], "low", true, true),

      new _classes_js__WEBPACK_IMPORTED_MODULE_0__.Todo("2) Adding a to-do", "This is how you create a new to-do", date,"", [
      ...
      new _classes_js__WEBPACK_IMPORTED_MODULE_0__.Todo("3) Managing a to-do", "Here's what you can do with your to-dos", date,"", [
      ...
      new _classes_js__WEBPACK_IMPORTED_MODULE_0__.Todo("4) Hotkeys", "The hotkeys you can use on edit mode", date,"", [
      ...
      new _classes_js__WEBPACK_IMPORTED_MODULE_0__.Todo("About", "To-do project created by Hector Vilas", date,"", [
...

  {
    ...
    todos: [
      new _classes_js__WEBPACK_IMPORTED_MODULE_0__.Todo("exercise", "It's leg day!", date, "", [
        { task: "run 3km", isDone: true },
        { task: "bicycle", isDone: false },
        { task: "squats", isDone: false },
      ], "middle", false, true),

      new _classes_js__WEBPACK_IMPORTED_MODULE_0__.Todo("coding", "", date, "", [
...
/* harmony export */ });
/* harmony import */ var _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todoHandler.js */ "./src/modules/todoHandler.js");
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/intlFormatDistance/index.js");
...
const ui = (() => {
  ...
  function loadMenu(){
    ...
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.loadSample();
    ...
    darkModeCheckbox.checked = _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.isOnDarkMode();
  ...
  function projectsList(redraw = false){
    ...
    const projectsList = _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.getProjectsTitles();
  ...
  function placeSingleCard(todo, projectIdx, todoIdx){
    ...
    dateCreation.innerText = `Created: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todo.dateCreation)), dateFormat)}`;
    ...
    dateDue.innerText = todo.dateDue.length > 0 ? `Due: ${
      (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todo.dateDue)), dateFormat)} (${
        (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(dueDateFormat)) ? "today" 
        : (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(dueDateFormat), new Date())
      })` : "";
  ...
  function editButtonsDiv(todo, projectIdx, todoIdx){
    ...
    pin.addEventListener("click", _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.togglePin);
    ...
    fav.addEventListener("click", _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.toggleFav);
  ...
  function placeCards(idxOrFilter, activateTodo){
    ...
    const project = _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.getProject(idxOrFilter);
  ...
  function cardPlace(){
    ...
    if(cardMove.from.project && cardMove.from.todo
      ...
      _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.moveDraggedCard(cardMove.from.project, cardMove.from.todo, cardMove.to.todo, cardMove.position);
  ...
  function cardDelete(projectIdxParam, todoIdxParam){
    ...
    if(_todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.getFavStatus(projectIdx, todoIdx)) {
    ...
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.deleteTodo(projectIdx, todoIdx);
  ...
  function createTask(projectIdxParam, todoIdxParam, todoParam){
    ...
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.createTask(projectIdx, todoIdx);
  ...
  function deleteTask(paramProjectIdx, paramTodoIdx, paramTaskIdx){
    ...
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.deleteTask(projectIdx, todoIdx, taskIdx);
    if(this){
  ...
  function editField(){
    ...
    if(this.className.includes("edit-title")){
      _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.editTitle(projectIdx, todoIdx, this.value);
      ...
      _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.editDescription(projectIdx, todoIdx, this.value);
      ...
      _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.editDateDue(projectIdx, todoIdx, this.value)
      ...
      thisDateDue.innerText = this.value.length > 0 ? `Due: ${
        (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(this.value)), dateFormat)} (${
          (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(dueDateFormat)) ? "today" 
          : (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(dueDateFormat), new Date())
        })` : "";
      
    } else if(this.className.includes("edit-label")){
      _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.editLabel(projectIdx, todoIdx, taskIdx, this.value);
  ...
  function deleteProject(projectIdx){
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.deleteProject(projectIdx);
  ...
  function changePriority(){
    const projectIdx = this.dataset.projectIdx;
    const todoIdx = this.dataset.todoIdx;
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.changePriority(projectIdx, todoIdx, this.value);
  ...
  function createTodo(){
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.createTodo(this.dataset.projectIdx);
    placeCards(parseInt(this.dataset.projectIdx));
  ...
  function createProject(){
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.createProject();
    projectsList(true);
    placeCards(parseInt(_todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.getProjectsTitles().length-1));
  }
  ...
  function editProjectTitle(){
    ...
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.editProjectTitle(projectIdx, this.value);
  ...
  function filterTodos(){
    ...
    const project = _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.getProject(this.dataset.filter);
  ...
  function taskCheck(projectIdxParam, todoIdxParam, taskIdxParam){
    ...
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.taskCheck(projectIdx, todoIdx, taskIdx);

    updateProgress(projectIdx, todoIdx);
  }

  function updateProgress(projectIdx, todoIdx){
    const thisProject = _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.getProject(parseInt(projectIdx)).todos[todoIdx];
  ...
  function loadDarkMode(){
    if(_todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.isOnDarkMode()) {
  ...
  function toggleDarkMode(){
    ...
    _todoHandler_js__WEBPACK_IMPORTED_MODULE_0__.todoHandler.darkMode(this.checked);
  }
...
/***/ "./src/media/images/background/github-mark.svg":
/*!*****************************************************!*\
  !*** ./src/media/images/background/github-mark.svg ***!
  \*****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "258106dd93825620cc4a.svg";

/***/ }),

/***/ "./src/media/images/icons/add-task.svg":
/*!*********************************************!*\
  !*** ./src/media/images/icons/add-task.svg ***!
  \*********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "6717bad86df0d89f40c7.svg";
...
/***/ "./src/media/images/icons/due.svg":
/*!****************************************!*\
  !*** ./src/media/images/icons/due.svg ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "c0a241529234fd5eaf05.svg";
...
module.exports = __webpack_require__.p + "9612eeb257242063467d.svg";
